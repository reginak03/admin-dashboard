...
const LineChart = () => {
  ...
  return (
    <ChartComponent id="line-chart" height="420px" primaryXAxis={LinePrimaryXAxis} primaryYAxis={LinePrimaryYAxis} chartArea={{ border:{width:0} }} legendSettings={{ textStyle:{ color:textColor } }} tooltip={{ enable:true }} background={ currentMode === 'Dark' ? '#33373E':'#fff' }> 
